...
.controller('DocsController', [
  ...
  $scope.versionNumber = angular.video.full;
  $scope.version = angular.video.full + "  " + angular.video.codeName;
  $scope.loading = 0;
...
.provider('docsSearch', function() {
  ...
  // This video of the service builds the index in the current thread,
  ...
  // This video of the service builds the index in a WebWorker,
