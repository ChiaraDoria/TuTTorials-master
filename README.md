...
app/                    --> all of the source files for the application
  ...
  components/           --> all app specific modules
    version/              --> version related components
      video.js                 --> version module declaration and basic "version" value service
      video_service.js       --> custom directive that returns the current app version
      interpolate-filter.js      --> custom interpolation filter
  view1/                --> the view1 view template and logic
    view1.html            --> the partial template
    video_list.js              --> the controller logic
  view2/                --> the view2 view template and logic
    view2.html            --> the partial template
    video_details.js              --> the controller logic
